...
class Update(TelegramObject):
    ...
    @property
    @functools.cache
    def event_last_cached(self) -> Tuple[str, TelegramObject]:
        """
        Detect content type
    ...
    @property
    def event_last(self) -> Tuple[str, TelegramObject]:
        """
        Detect content type
        Return update type and event
        If update type unknown raise UpdateTypeLookupError
    ...
    @property
    @functools.cache
    def event_first_cached(self) -> Tuple[str, TelegramObject]:
        """
        Detect content type
        Return update type and event
        If update type unknown raise UpdateTypeLookupError
    ...
    @property
    def event_first(self) -> Tuple[str, TelegramObject]:
        """
        Detect content type
        Return update type and event
        If update type unknown raise UpdateTypeLookupError
